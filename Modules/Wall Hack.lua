...
if not getgenv().Pakkhub or getgenv().Pakkhub.WallHack then return end
...
local Environment = getgenv().Pakkhub.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().Pakkhub.WallHack.Functions = nil
	getgenv().Pakkhub.WallHack = nil
