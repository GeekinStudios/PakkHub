...
if not getgenv().Pakkhub or getgenv().Pakkhub.Aimbot then return end
...
local Environment = getgenv().Pakkhub.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().Pakkhub.Aimbot.Functions = nil
	getgenv().Pakkhub.Aimbot = nil
